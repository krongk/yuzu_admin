  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved product as @product" do
        ...
        post :create, {:product => { "user" => "invalid value" }}, valid_session
        assigns(:product).should be_a_new(Product)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product" do
        ...
        Product.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => product.to_param, :product => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the product as @product" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Product.any_instance.stub(:save).and_return(false)
        put :update, {:id => product.to_param, :product => { "user" => "invalid value" }}, valid_session
        assigns(:product).should eq(product)
      end
